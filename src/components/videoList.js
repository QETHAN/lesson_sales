  ...
  return (
    <div className="container lg:max-w-screen-lg mx-auto px-5 lg:px-0 pb-10">
      ...
      <ul className="flex flex-col md:flex-row flex-wrap justify-between">
        <li className="basis-[calc(50%-10px)]">
          <a
            className="flex items-center"
            href=""
            aria-label="用 iPhone 14 拍摄：摄影佳作激发创作灵感，定格精彩人像、自然与城市风光 - 新闻稿 - 发表时间 2035 年 9 月 1 日"
          >
            <div
              className="w-[105px] md:w-[132px] h-[105px] md:h-[132px] rounded-lg overflow-hidden"
              aria-hidden={true}
            >
              <img
                className="image object-cover h-full hover:scale-[1.03]"
            ...
            <div className="flex-1 px-4 py-2.5 lg:p-6">
              <h2 className="text-lg md:text-xl font-bold line-clamp-6">
                用 iPhone 14
                拍摄：摄影佳作激发创作灵感，定格精彩人像、自然与城市风光
              </h2>
            </div>
          </a>
        </li>

        <li className="md:hidden w-full my-5 h-px bg-gray-200"></li>
        ...
        <li className="basis-[calc(50%-10px)]">
          ...
          >
            ...
            >
              <img
                className="image object-cover h-full rounded-lg hover:scale-[1.03]"
                alt="lt"
        ...
        <li className="w-full my-5 md:my-8 h-px bg-gray-200"></li>
